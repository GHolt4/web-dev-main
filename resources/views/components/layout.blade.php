...
<body class="h-full">
    ...
    <nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="shrink-0">
                <img class="size-11" src="https://i.ibb.co/zSYyyNR/Logo-no-background.png" alt="Your Company">
            </div>
            ...
            <button type="button" class="relative inline-flex items-center justify-center rounded-md bg-gray-800 p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" aria-controls="mobile-menu" aria-expanded="false" onclick="toggleMenu()">
                ...
                <svg class="block size-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon-open">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                </svg>
                <!-- Menu open: "block", Menu closed: "hidden" -->
                <svg class="hidden size-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon-close">
            ...
            <script>
                function toggleMenu() {
                    ...
                    const iconOpen = document.querySelector('[data-slot="icon-open"]');
        ...
        <div class="ml-4 flex items-center md:ml-6">
            @guest
                    <x-nav-link href="/login" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white" :active="request()->is('login')">Login</x-nav-link>
                    <x-nav-link href="/register" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white" :active="request()->is('register')">Register</x-nav-link>
                @endguest
                @auth
                    <form method="POST" action="/logout">
                        @csrf
    ...
    <section class="bg-white">
        <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
            ...
            <p class="mt-8 text-base leading-6 text-center text-gray-400">
                Copyright © 2025 George Holt - Heart of Yorkshire Education Group & University of Hull. Inc. All rights reserved.
            </p>
        </div>
    </section>
</body>
